...
function scaffoldPhaseStubs(dirPath: string, phaseId: string, name: string): void {
  ...
  server.tool(
    ...
    async ({ name }) => {
      try {
        ...
        scaffoldPhaseStubs(dirPath, paddedNum, name);
  ...
  server.tool(
    ...
    async ({ name, after }) => {
      try {
        ...
        scaffoldPhaseStubs(dirPath, decimalPhase, name);
