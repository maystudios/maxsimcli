...
async function main() {
	...
	switch (command) {
		...
		case "frontmatter": {
			...
			else error("Unknown frontmatter subcommand. Available: get, set, merge, validate");
			break;
		}
		case "verify": {
			const subcommand = args[1];
			...
			else error("Unknown verify subcommand. Available: plan-structure, phase-completeness, references, commits, artifacts, key-links");
			break;
		}
		case "generate-slug":
		...
		case "roadmap": {
			...
			else error("Unknown roadmap subcommand. Available: get-phase, analyze, update-plan-progress");
			break;
		}
		case "requirements":
		...
		case "phase": {
			...
			else error("Unknown phase subcommand. Available: next-decimal, add, insert, remove, complete");
			break;
		}
		case "milestone":
			if (args[1] === "complete") {
		...
		case "validate": {
			...
			} else error("Unknown validate subcommand. Available: consistency, health");
			break;
		}
		case "progress": {
