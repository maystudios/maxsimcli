...
async function install(isGlobal, runtime = 'claude') {
    ...
    (0, copy_js_1.copyWithPathReplacement)(maxsimSrc, maxsimDest, pathPrefix, runtime, explicitConfigDir);
...
async function promptLocation() {
    ...
    const globalPath = (0, shared_js_1.getGlobalDir)('claude', explicitConfigDir).replace(os.homedir(), '~');
...
async function installForClaude(isGlobal, isInteractive) {
    ...
    (0, hooks_js_1.finishInstall)(result.settingsPath, result.settings, result.statuslineCommand, shouldInstallStatusline, result.runtime, isGlobal);
}
// Main logic
...
(async () => {
    ...
    if (hasGlobal && hasLocal) {
        ...
        (0, uninstall_js_1.uninstall)(hasGlobal, 'claude', explicitConfigDir);
    }
