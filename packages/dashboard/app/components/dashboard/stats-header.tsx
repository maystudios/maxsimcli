...
import type { ParsedState } from "@/lib/parsers";
 ...
 *
 * Displays milestone progress, current phase, open blockers count,
 * and open todos count in a horizontal data-dense layout.
 */
export function StatsHeader({ roadmap, state, todos }: StatsHeaderProps) {
  ...
  // Count open (unresolved) blockers from state
  const openBlockers =
