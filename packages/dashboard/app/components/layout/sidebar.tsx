 ...
 *
 * Fixed-width (w-64), dark bg-card, full height. Sections: logo, phase nav,
 * secondary nav (todos/blockers), and footer with connection status.
 */
    ...
    <aside className="flex h-full w-64 shrink-0 flex-col border-r border-border bg-card">
      ...
      <div className="flex-1 overflow-y-auto py-2">
        ...
        <nav className="flex flex-col gap-0.5 px-1">
          {phases.map((phase) => {
            const isActive =
              activeView === "phase" && activePhaseId === phase.number;
